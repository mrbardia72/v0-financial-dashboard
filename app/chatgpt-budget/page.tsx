...
import { DollarSign, Calendar, CheckCircle, BarChart3, Target, Lightbulb, TrendingUp, ArrowLeft } from "lucide-react"
import Link from "next/link"

export default function ChatGPTBudgetPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0A0A0B] p-4">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-[#0F0F12] rounded-xl p-8 border border-gray-200 dark:border-[#1F1F23]">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-gray-50 dark:bg-[#1A1A1E] rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-gray-900 dark:text-white mb-1">$0.0180</div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Daily Cost</p>
              </div>
              <div className="bg-gray-50 dark:bg-[#1A1A1E] rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-gray-900 dark:text-white mb-1">$0.0234</div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Weekend Cost</p>
              </div>
              <div className="bg-gray-50 dark:bg-[#1A1A1E] rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-gray-900 dark:text-white mb-1">$0.1368</div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Weekly Cost</p>
              </div>
              <div className="bg-gray-50 dark:bg-[#1A1A1E] rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-gray-900 dark:text-white mb-1">$0.5923</div>
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/10 rounded-xl p-6 border border-yellow-200 dark:border-yellow-800">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">Your budget is in good condition</p>
                </div>
                <div className="flex items-start gap-3">
                  <Calendar className="w-5 h-5 text-blue-600 dark:text-blue-400 mt-0.5 flex-shrink-0" />
                  <p className="text-gray-700 dark:text-gray-300">
                    Try to reduce weekend usage for better cost management
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <DollarSign className="w-5 h-5 text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0" />
                  <p className="text-gray-700 dark:text-gray-300">
                    To save costs, break long texts into smaller chunks
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <TrendingUp className="w-5 h-5 text-purple-600 dark:text-purple-400 mt-0.5 flex-shrink-0" />
                  <p className="text-gray-700 dark:text-gray-300">
                    Monitor your daily usage to stay within budget limits
                  </p>
                </div>
              </div>
            </div>
